...
if show_plot
    ...
    hold off
    title('NEES Estimation Results','FontSize',14, 'Interpreter','latex')
    ylabel('NEES stat, $\bar{\epsilon_k}$','FontSize',12, 'Interpreter','latex')
    xlabel('time step, k','FontSize',12, 'Interpreter','latex')
    legend('NEES val','Upper Bound','Lower Bound','FontSize',12, 'Interpreter','latex')
end
